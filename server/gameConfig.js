...
global.NUM_POWERUPS_ONBOARD = 10;
...
global.LINK_RANGE = 5; // link will start at this distance
global.LINK_SUSTAIN = 8; // link will stay alive at this range (hysteresis)
global.LINK_ALLIANCE_T = 0.4; // players need to be roughly the same before they can ally
